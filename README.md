...
LangTARS is a **LangBot native plugin** built on the Nanobot kernel, designed to bring the **OpenClaw** experience to LangBot users. It enables you to control your Mac through IM messages using autonomous AI task planning.
